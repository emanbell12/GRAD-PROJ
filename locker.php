...
<body>
    ...
    $sql = "SELECT * FROM facility WHERE Type = 'Locker'";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            $id = $row["ID"];
            echo '<div class="lab1">';
            echo "<h1>" . "Locker: " . $row["Building"] . "</h1>";
            echo "<p>" . "Building: " . $row["Building"] . "<br>" . "</p>";
            echo "<p>" . "Description: " . $row["Description"] . "<br>" .  "</p>";
            echo '<form onsubmit="redirectToConfirmationPage(\'locker2.php\', \'' . $id . '\'); return false;">';
